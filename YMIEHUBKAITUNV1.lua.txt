...
getgenv().Setting = {
    ...
    ["Discord"] = "https://discord.com/invite/54ZpuRS8r9
    ",
    ["RemoveEffect"] = true,
    ["RandomFruit"] = true,
    ["CollectFruit"] = true,
...
if not getgenv().Setting.Discord == "https://discord.com/invite/54ZpuRS8r9
" then
game.Players.LocalPlayer:Kick("YMIE HUB Invite")
end
